...
library(Seurat)
library(dplyr)
crc.obj <- Read10X_h5("../data/VisiumHD/HumanColonCancer_Flex_Multiplex_count_filtered_feature_bc_matrix.h5")


crc.sc.obj <- CreateSeuratObject(crc.obj)
crc.sc.obj$orig.ident <- "CRC"
metadata <- read.csv("../data/VisiumHD/SingleCell_MetaData.csv")
...
saveRDS(sc.obj,file = "../data/VisiumHD/sc.obj.rds")
